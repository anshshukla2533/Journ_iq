...
const ChatWelcome = () => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-white p-4 sm:p-8 overflow-y-auto">
      {/* Welcome Illustration */}
      <div className="mb-6 sm:mb-8 relative flex-shrink-0">
        ...
        <div className="absolute -bottom-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 bg-green-100 rounded-full flex items-center justify-center">
          <svg 
      ...
      {/* Welcome Text */}
      <h1 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3 text-center">
        Welcome to JournIQ Chat
      </h1>
      
      <div className="max-w-md text-center space-y-3 sm:space-y-4 px-2">
        ...
        {/* Feature List */}
        <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-6 sm:mt-8 text-xs sm:text-sm">
          <div className="p-3 sm:p-4 rounded-lg bg-blue-50 border border-blue-100">
            <div className="text-blue-600 mb-1 sm:mb-2">
            ...
            <p className="text-gray-600 text-xs">Instant messaging</p>
          </div>
          
          <div className="p-3 sm:p-4 rounded-lg bg-green-50 border border-green-100">
            <div className="text-green-600 mb-1 sm:mb-2">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="font-medium text-gray-800 mb-1">Video Calls</h3>
            <p className="text-gray-600 text-xs">Face-to-face</p>
          </div>
          
          <div className="p-3 sm:p-4 rounded-lg bg-purple-50 border border-purple-100">
            <div className="text-purple-600 mb-1 sm:mb-2">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="font-medium text-gray-800 mb-1">Share Notes</h3>
            <p className="text-gray-600 text-xs">Collaborate</p>
          </div>
          
          <div className="p-3 sm:p-4 rounded-lg bg-yellow-50 border border-yellow-100">
            <div className="text-yellow-600 mb-1 sm:mb-2">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-gray-600 text-xs">Clear voice</p>
          </div>
        </div>
      </div>
    </div>
